...
public class Fixtures {
    ...
    public static final Person francesco = new Person("Francisco", 18);
    ...
    public static final List<Person> citizenW= new ArrayList<>(Arrays.asList(david, erica, francesco));
}
